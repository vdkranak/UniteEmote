...
{
    public class QuickAccessAppFactory : HubViewFactory
    {
            ...
            PhysicalDisplay display, Dispatcher currentUiDispatcher, EventHandler<HubViewEventArgs> eventCommandInvoker)
        {
            ...
            return new QuickAccessApp(runtimeContext, createContract, display, currentUiDispatcher, eventCommandInvoker);
        }
    }
}